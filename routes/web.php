...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => 'teacher'], function () {
    ...
    Route::get('/search-tag', 'TagAdminController@search')->name('tag.search');
    Route::resource('lessons', 'LessonAdminController');
    Route::get('/search-lesson', 'LessonAdminController@search')->name('lessons.search');
});
